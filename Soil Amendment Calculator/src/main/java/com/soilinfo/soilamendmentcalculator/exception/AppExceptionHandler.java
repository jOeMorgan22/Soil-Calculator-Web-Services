...
public class AppExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({UsernameNotFoundException.class, AppUserNotFoundException.class, SoilReportNotFoundException.class})
    ...
    public ResponseEntity<Object> handleAppUserAlreadyExistsException(AppUserAlreadyExistsException ex) {
        ErrorResponse error = new ErrorResponse(List.of("Username already exists."));
        return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
    }
